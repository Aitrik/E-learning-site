            ...
            <div className="hidden lg:flex w-1/2 relative bg-gray-900 overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col justify-between p-12 text-white">
                    ...
                    <div className="max-w-md">
                        <h1 className="text-4xl font-bold mb-4">Empower Your Future</h1>
                        <p className="text-lg text-gray-200">
                            Log in to continue your learning journey and unlock access to thousands of top-tier courses and resources.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex-1 flex flex-col justify-center items-center p-6 md:p-12 bg-white text-[#1c1d1f] relative">
                ...
                <div className="w-full max-w-[420px] space-y-8 mt-12 lg:mt-0">
                    <div className="text-center space-y-2">
                        <h2 className="text-3xl font-bold tracking-tight text-[#1c1d1f]">Welcome back</h2>
                        ...
                        <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <Link href="#" className="text-sm font-bold text-brand-primary hover:text-brand-secondary transition-colors underline-offset-4 hover:underline">
                                        Forgot password?
                                    </Link>
                                </div>
                    ...
                    <div className="text-center text-sm text-gray-500 font-medium">
                        ...
                        <Link href="/signup" className="text-brand-primary font-bold hover:text-brand-secondary transition-colors hover:underline underline-offset-4">
                            Sign up
                        </Link>
                    </div>
                </div>
